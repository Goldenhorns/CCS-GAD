...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_epochs", type=int, default=1 , required=False)
    parser.add_argument("--hidden_dim", type=int, default=45, required=False)
    ...
    parser.add_argument("--testround", type=int, default=1, required=False)
    parser.add_argument("--balance", type=float, default=0.3, required=False)
